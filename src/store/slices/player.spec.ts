...
describe('player slice', () => {
   it('should be able to jumple to the next module automatically', () => {
      const state = reducer({
         ...exampleState,
